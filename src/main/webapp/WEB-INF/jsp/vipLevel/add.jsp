...
<div class="pd-20 minwidth">
    <form class="form form-horizontal" id="form-vipLevel-add" action = "<%=request.getContextPath()%>/server/vip/vipLevelAdd" type = "post">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-7">
                <input type="text" class="input-text radius" value=""  id="rebate" name = "rebate"><br/>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-7">
                <div class="radio-box">
                    <input type="radio" id="level_using-1" name="integral" value = "1" checked>
                    <label for="level_using-1">是</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="level_using-2" name="integral" value = "0">
